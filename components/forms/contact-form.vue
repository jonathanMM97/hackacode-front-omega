  ...
  <form class="hk-contact-form" @submit.prevent="validateForm">
    <div class="hk-contact-form__fields">
      <FieldForm
        ...
        id="'name'"
        :messageLabel="$t('contact-us.form-1')"
        :model-value="state.name"
        :error="test"
        messageError="'Must be at least 2 characters'"
        :placeholder="$t('contact-us.placeholder-1')"
        @onChange="changeName"
      />
      <FieldForm
        class="hk-contact-form__field"
        id="'email'"
        :messageLabel="$t('contact-us.form-2')"
        :model-value="state.email"
        :error="test"
        messageError="'Invalid email'"
        :placeholder="$t('contact-us.placeholder-2')"
        @onChange="changeEmail"
      />
      <FieldForm
        class="hk-contact-form__field"
        id="'text'"
        :messageLabel="$t('contact-us.form-3')"
        :model-value="state.message"
        :error="test"
        messageError="'Must be at least 10 characters'"
        :placeholder="$t('contact-us.placeholder-3')"
